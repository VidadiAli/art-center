  ...
  return (
    <div className='azerbaijan'>
      ...
      <div className='second-part'>
        <h1>
          Azərbaycan Sənətkarlıq Nümunələri
        </h1>
        <ol>
          <li>
            <span>
          ...
          <li>
            <span>
              Milli Musiqi Alətləri İstehsalı
            </span>
            <p>
        ...
        <h1>Azərbaycan Sənətkarlığının Əhəmiyyəti</h1>
        <p>
...
export default Azerbaijan
 ...
 //  Yuxari Qaldirmali Icon //


// import React, { useState, useEffect } from 'react';
// import './Azerbaijan.css';
// import image1 from '../../Images/aze.jpg'; // Bu resmi kullanmak istersen yorum satırını kaldırabilirsin
// import { FaArrowCircleUp } from 'react-icons/fa'; // Yeni eklenen  ikon
...
//     <div className='azerbaijan'>
//       <div className='first-part'>
//         {/* <img src={image1} alt="Azerbaijan Craftsmanship" /> */}
//         <h1>
//           Azərbaycan Sənətkarlığı
//         </h1>
//         <p>
